...
- **`WRP_CTE_CONF`**: Path to the generated CTE configuration file
...
4. Sets `WRP_CTE_CONF` environment variable
...
- **CTE Core Module**: Uses generated configuration via `WRP_CTE_CONF`
